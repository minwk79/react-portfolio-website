...
export default function Header() {
  return (
    ...
    <div className='container flex py-20 items-center justify-center flex-col'>
      ...
      <div className='text-center lg:w-2/3 w-full'>
        <h1 className='primaryText'>Min Woo Kwak</h1>
        <p className='description'>Welcome to my Web Portfolio! <br />You can call me Min. <br />I'm a software/application developer, etc</p>
