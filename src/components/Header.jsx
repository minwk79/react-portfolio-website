  ...
  return (
    <div name="home" className="container pt-32 flex flex-col justify-center">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full gap-4">
        <p className="text-light-secondary dark:text-dark-text text-2xl md:text-4xl hover:scale-110 duration-300">
          Hello! <br /> My Name Is{" "}
        </p>
        {/* <img className='py-6 w-1/3 md:w-1/6 mb-10 object-cover object-center rounded-full' alt='me' src={myImg}></img> */}
        <h1 className="text-light-primary dark:text-dark-primary text-4xl md:text-6xl font-bold hover:scale-110 duration-300">
          Minwoo Kwak
        </h1>
        <h2 className="text-light-secondary dark:text-dark-text text-2xl md:text-4xl font-bold hover:scale-110 duration-300">
          I'm a Software Developer
        </h2>
        <p className="text-light-text dark:text-dark-text py-4 max-w-[700px] hover:scale-110 duration-300">
          &lt;Myself&gt; <br />
        ...
        <div className="flex justify-center">
          <a className="primaryBtn gap-2" href={resume} download>
            <AiOutlineDownload size={20} />
            <p>Resume</p>
          </a>
          <a
            className="ml-4 secondaryBtn gap-2"
